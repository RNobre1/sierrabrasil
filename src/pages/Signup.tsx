...
export default function Signup() {
  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden">
      {/* Ambient glows */}
      <div className="ambient-glow" style={{ background: "hsl(225 80% 56%)", top: "-200px", right: "-200px" }} />
      <div className="ambient-glow" style={{ background: "hsl(190 90% 50%)", bottom: "-300px", left: "-200px", animationDelay: "4s" }} />
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-center justify-center p-12">
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-4xl font-bold leading-tight tracking-tight text-foreground">
            Seu melhor <span className="text-gradient">funcionário digital</span>. Trabalha 24h.
          </h1>
          ...
          <form onSubmit={handleSignup} className="space-y-3.5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="h-10 rounded-xl bg-secondary/50 border-border/50 pl-[72px] text-sm font-mono placeholder:text-muted-foreground/50"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-10 rounded-xl bg-secondary/50 border-border/50 pr-10 text-sm placeholder:text-muted-foreground/50"
                />
                <button
                  type="button"
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="h-10 rounded-xl bg-secondary/50 border-border/50 text-sm placeholder:text-muted-foreground/50"
              />
